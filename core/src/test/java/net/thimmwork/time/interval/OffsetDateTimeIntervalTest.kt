...
class OffsetDateTimeIntervalTest {
    val year2018withCEToffset =
        OffsetDateTimeInterval(parse("2018-01-01T00:00:00+01:00"), parse("2019-01-01T00:00:00+01:00"))
    ...
    fun `the 20th century is normalized to 1970-2000`() {
        val twentiethCentury =
            OffsetDateTimeInterval(parse("1900-01-01T00:00:00+01:00"), parse("2000-01-01T00:00:00+01:00"))
    ...
    fun `an interval up to year 5k is normalized to dec 31th 4000`() {
        val hugeInterval =
            OffsetDateTimeInterval(parse("2000-01-01T00:00:00+01:00"), parse("5000-01-01T00:00:00+01:00"))
    ...
    fun `two intervals with same bounds are equal`() {
        val otherInterval = OffsetDateTimeInterval(year2018withCEToffset.start, year2018withCEToffset.end)
        val differentInterval =
            OffsetDateTimeInterval(year2018withCEToffset.start, year2018withCEToffset.end.plusSeconds(1))
    ...
    fun `gap throws IllegalArgumentException on overlapping intervals`() {
        val overlappingInterval2018_19 =
            OffsetDateTimeInterval.parse("2018-12-01T00:00:00+01:00", "2020-01-01T00:00:00+01:00")
    ...
    fun `gap returns gap on succeeding interval`() {
        ...
        assertTrue {
            year2018withCEToffset.gap(jan2nd2019) == OffsetDateTimeInterval.parse(
...
class OffsetDateTimeIntervalOverlapsTests {
    val t1 = parse("2000-01-01T00:00:00Z")
    val t2 = parse("2000-02-01T00:00:00Z")
    val t3 = parse("2000-03-01T00:00:00Z")
    val t4 = parse("2000-04-01T00:00:00Z")
...
class OffsetDateTimeIntervalOverlapTests {
    val t1 = parse("2000-01-01T00:00:00Z")
    val t2 = parse("2000-02-01T00:00:00Z")
    val t3 = parse("2000-03-01T00:00:00Z")
    val t4 = parse("2000-04-01T00:00:00Z")
